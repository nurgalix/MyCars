...
class ViewController: UIViewController {
    ...
    private func getDataFromFile() {
        guard let pathToFile = Bundle.main.path(forResource: "data", ofType: "plist"),
              let dataArray = NSArray(contentsOfFile: pathToFile) else  { return } // двойной гуард если не получится получить path to file или же не получится достать аррей из data.plist то прост return
...
//        }
        ...
        do {
            ...
            let acar = results.first
            insertDataFrom(selectedCar: acar!)
